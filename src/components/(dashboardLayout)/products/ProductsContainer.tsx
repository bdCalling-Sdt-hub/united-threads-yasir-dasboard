...
const ProductsContainer = () => {
  ...
  const products: any[] = [
    ...
    },
    {
      ...
      description:
        "This 55-inch Ultra HD 4K Smart LED TV offers crystal-clear picture quality, built-in streaming apps, and voice control features. A great addition to any living room.",
    ...
    },
    {
      ...
      description:
        "The Gaming Laptop Pro features a high-performance Intel i7 processor, 16GB RAM, and an NVIDIA RTX 3070 GPU. Perfect for gaming and heavy computing tasks.",
    ...
    },
    {
      ...
      description:
        "The Smartphone X Ultra offers a stunning edge-to-edge display, 128GB storage, and 5G support. Capture amazing photos with the triple-camera system.",
    ...
    },
    {
      ...
      description:
        "This electric scooter features a powerful motor, 25-mile range, and a foldable design for easy storage. Perfect for city commutes and recreational rides.",
